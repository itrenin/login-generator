...
var _internalProtoAccess = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__passwordGenerator__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__loginGenerator__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_result_hbs__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_result_hbs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__templates_result_hbs__);
...
var checkSymbols = document.querySelector('#symbols');
var numberOfSymbols = document.querySelector('#number-of-symbols');
var letters = 'abcdefghijklmnopqrstuvwxyz';
var capitalsLetters = letters.toUpperCase();
var digits = '0123456789';
var symbols = '~@#$%^&*()_-+={}|/[]<>?';
resultButton.addEventListener('click', function (e) {
  e.preventDefault(); // console.log(checkLetters.checked)
  ...
  if (!fullNameField.value) {
    ...
    result = {
      error: 'В ФИО должно быть введено минимум 2 слова: фамилия и имя через пробел'
    };
  } else if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__isEmpty__["a" /* default */])(content)) {
    result = {
      error: 'Для пароля должен быть указан хотя бы один параметр генерации (чекбокс сверху)'
    };
  } else {
    result = {
      ...
      login: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__loginGenerator__["a" /* default */])(fullNameField.value.toString()),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_cyrillic_to_translit_js_CyrillicToTranslit__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_cyrillic_to_translit_js_CyrillicToTranslit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_cyrillic_to_translit_js_CyrillicToTranslit__);

function login(string) {
  var loginString = [];
  var tempString = __WEBPACK_IMPORTED_MODULE_0_cyrillic_to_translit_js_CyrillicToTranslit___default()().transform(string, ' ').toLowerCase();
  tempString = tempString.split(' '); //console.log(tempString)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__passwordValidation__ = __webpack_require__(12);

function generator(length, content) {
  var expression = '';
  ...
  var maxPosition = expression.length - 1;
  var password = '';
  ...
  console.log("\u0412\u0430\u043B\u0438\u0434\u043D\u043E\u0441\u0442\u044C \u043F\u0430\u0440\u043E\u043B\u044F: ".concat(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__passwordValidation__["a" /* default */])(password, content))); // if (!validator(password, content)) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isEmpty__ = __webpack_require__(2);

function validator(password, parameters) {
  if (!password.length || __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__isEmpty__["a" /* default */])(parameters)) {
    return false;
  }
  ...
  if (valid === false) {
    console.log("\u043F\u0430\u0440\u0430\u043C\u0435\u0442\u0440 \u0432\u044B\u043B\u0435\u0442\u0430: ".concat(param));
  }
...
module.exports = function cyrillicToTranslit(config) {
  const invert = __webpack_require__(31);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"result\">\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"error") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":8},"end":{"line":4,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"fullName") : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":8},"end":{"line":7,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"login") : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":8,"column":8},"end":{"line":11,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"password1") : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":12,"column":8},"end":{"line":15,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"password2") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":8},"end":{"line":19,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"password3") : depth0),{"name":"if","hash":{},"fn":container.program(11, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":20,"column":8},"end":{"line":23,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"password4") : depth0),{"name":"if","hash":{},"fn":container.program(13, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":24,"column":8},"end":{"line":27,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"password5") : depth0),{"name":"if","hash":{},"fn":container.program(15, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":28,"column":8},"end":{"line":31,"column":15}}})) != null ? stack1 : "")
    + "</div>";
},"useData":true});
